...
function idesign_import_files() {
  return array(
  	/**/
    array(
      'import_file_name'             	=> 'i-Design Demo Design 18',
      'import_file_url'            		=> 'https://raw.githubusercontent.com/TemplatesNext/i-design-demo/master/i-design.wordpress-design-18.xml',
      'import_widget_file_url'     		=> 'https://raw.githubusercontent.com/TemplatesNext/i-design-demo/master/i-design-widgets.wie',
      'import_customizer_file_url' 		=> 'https://raw.githubusercontent.com/TemplatesNext/i-design-demo/master/i-design-export-design-18.dat',
      'import_preview_image_url'     	=> 'https://raw.githubusercontent.com/TemplatesNext/i-design-demo/master/i-design-demo-design-18.jpg',
    ...
    array(
      ...
      'import_notice'                	=> __( 'Please make sure you have plugin "TemplatesNext ToolKit" and "Contact Form 7" installed and active before you start the import process. <br> This process involves transfer of data and media from server to server and might take some time.', 'i-design' ),
	  'preview_url'                		=> 'http://www.templatesnext.org/idesign/?page_id=325',
    ),
...
function idesign_after_import_setup($selected_import) {
	...
	} elseif ( 'i-Design Demo Design 18' === $selected_import['import_file_name'] ) {
		...
		$front_page_id = get_page_by_title( 'Design 18' );
       	if ( isset( $front_page_id->ID ) ) {
			update_option( 'page_on_front', $front_page_id->ID );
        	update_option( 'show_on_front', 'page' );
       	}			
