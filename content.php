        ...
        <div class="post-mainpart">    
            ...
            <div class="entry-content">
				...
				<?php
                    ...
                    {
                        the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'i-design' ) );
                    } else
                    {
						the_excerpt();
                    }
            ...
            <footer class="entry-meta">
                <?php if ( comments_open() && ! is_single() ) : ?>
                    <div class="comments-link">
                        <?php comments_popup_link( '<span class="leave-reply">' . __( 'Leave a comment', 'i-design' ) . '</span>', __( 'One comment so far', 'i-design' ), __( 'View all % comments', 'i-design' ) ); ?>
                    </div><!-- .comments-link -->
