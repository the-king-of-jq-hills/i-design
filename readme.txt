...
1. Upload the `i-design` folder to the `/wp-content/themes/` directory
...
* The script jquery.inview.js is licensed under GPL
* TGM-Plugin-Activation is licensed under GPL
* All images licensed under CC0 from www.pixabay.com

Images used/supplied are 
https://pixabay.com/en/book-bezel-read-reading-woman-841171/
